...
<nav id="sidebar" class='mx-lt-5 bg-dark' >
		...
		<div class="sidebar-list">
				...
				<a href="index.php?page=market" class="nav-item nav-market"><span class='icon-field'><i class="fa fa-user"></i></span> Marketplace </a>
				<a href="index.php?page=gallery" class="nav-item nav-gallery"><span class='icon-field'><i class="fa fa-image"></i></span> Featured Post </a>
				<a href="index.php?page=tracer" class="nav-item nav-tracer"><span class='icon-field'><i class="fa fa-book"></i></span> Tracer Study</a>
