            ...
            <div class="float-right">
                <div class=" dropdown mr-4">
                    <a href="#" class="text-white dropdown-toggle" id="account_settings" data-toggle="dropdown"
                       aria-haspopup="true" aria-expanded="false"><?php echo $_SESSION['login_first_name'] ?> </a>
                    <div class="dropdown-menu" aria-labelledby="account_settings" style="left: -5.5em;">
                        <a class="dropdown-item switch_page" id="switch_page"><i class="fa fa-table"></i> Portal</a>
...
<script>
    ...
    $('#switch_page').click(function () {
        location.replace('/alumni/index.php');
    })
</script>