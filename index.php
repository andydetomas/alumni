...
<div class="modal fade" id="confirm_modal" role='dialog'>
  ...
  <div id="preloader"></div>
        <footer class=" py-5">
            ...
            <br>
            <div class="container"><div class="small text-center text-muted"><?php echo $_SESSION['system']['name'] ?> | Jerrick Bucar , Kiev Xandri Perez, Kristel Mar Watiwat | Capstone Project 2022 - 2023</div></div>
        </footer>
