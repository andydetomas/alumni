...
<div class="container mt-3 pt-2">
    <h4 class="text-center text-white">On Sale and Upcoming Merch!</h4>
    <hr class="divider">
    <?php
    $event = $conn->query("SELECT * FROM market where date_format(schedule,'%Y-%m%-d') >= '".date('Y-m-d')."' order by unix_timestamp(schedule) asc");
            ...
            <div class="card-body">
                <div class="row  align-items-center justify-content-center text-center h-100">
                    <div class="">
                        ...
                        <div><small><p>
                                    <b><i class="fa fa-calendar"></i> <?php echo date("F d, Y h:i A", strtotime($row['schedule'])) ?>
                                    </b></p></small></div>
                        <hr>
